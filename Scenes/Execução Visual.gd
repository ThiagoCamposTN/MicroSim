...
func atualizar_registrador(registrador: String):
	match registrador:
		"A":
			get_node("Registradores/RegistradorAButton").text = Valor.new(CPU.registrador_a).como_hex(2)
		"B":
			get_node("Registradores/RegistradorBButton").text = Valor.new(CPU.registrador_b).como_hex(2)
		"PC":
			get_node("Registradores/RegistradorPCButton").text = Valor.new(CPU.registrador_pc).como_hex(4)
		"IX":
			get_node("Registradores/RegistradorIXButton").text = Valor.new(CPU.registrador_ix).como_hex(4)
		"MAR":
			get_node("Registradores/RegistradorMARButton").text = Valor.new(CPU.registrador_mar).como_hex(4)
		"PP":
			get_node("Registradores/RegistradorPPButton").text = Valor.new(CPU.registrador_pp).como_hex(4)
		"MBR":
			get_node("Registradores/RegistradorMBRButton").text = Valor.new(CPU.registrador_mbr).como_hex(2)
		"Z":
			get_node("Registradores/RegistradorZButton").text = Valor.new(CPU.flag_z).como_hex(1)
		"N":
			get_node("Registradores/RegistradorNButton").text = Valor.new(CPU.flag_n).como_hex(1)
		"C":
			get_node("Registradores/RegistradorCButton").text = Valor.new(CPU.flag_c).como_hex(1)
		"O":
			get_node("Registradores/RegistradorOButton").text = Valor.new(CPU.flag_o).como_hex(1)
		"IR":
			get_node("Registradores/RegistradorIRButton").text = Valor.new(CPU.registrador_ir).como_hex(2)
